...
const model = Schema.Model({
  ...
  price: NumberType("Must be numbers")
...
const ProductList = () => {
  ...
  const onSubmitProduct = (id?: string): void => {
    ...
    if (Object.keys(newProduct).length < 2) {
      return;
    }
    ...
    <Grid>
      ...
      <div className="modal-container">
        <Modal backdrop={"static"} open={open} onClose={closeModal}>
          <Modal.Header>
            <Modal.Title>
              {!newProduct._id ? "Adding New Product" : "Editing Product"}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form
              ...
              <Form.Group>
                <ButtonToolbar>
                  <Button
                    ...
                    appearance="primary"
                    type="submit"
                    onClick={() => onSubmitProduct(newProduct._id)}
                  >
                    Submit
                  </Button>
                  <Button
