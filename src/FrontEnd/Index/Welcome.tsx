...
const Welcome = () => {
  ...
  const isValidCount = (products: any[]) => {
    ...
    products.forEach(({ count }) =>
      count > 0 ? countIsValid++ : countIsValid
    );
  ...
  return (
    <div>
      ...
      <Grid>
        <Form
          formValue={newOrder}
          onChange={(clientName: Record<string, { clientName: string }>) =>
            onChangeValue(clientName)
          }
        >
          <FlexboxGrid>
                ...
                >
                  ...
                  <ButtonToolbar>
                    <Button
                      ...
                      onClick={() => dispatch(decrementCount(product._id))}
                    >
                      -
                    </Button>
                    ...
                    <Button
                      appearance="subtle"
                      onClick={() => dispatch(incrementCount(product._id))}
                    >
                      +
                    </Button>
                  </ButtonToolbar>
        ...
        <FlexboxGrid justify="end" style={{ marginTop: 20, marginBottom: 100 }}>
          <Form.Group>
            <ButtonToolbar>
              <Button color="orange" appearance="primary" onClick={onClear}>
                Clear
              </Button>
              <Button
                color="orange"
